...
function(photon_setup_embedded_asset_platform)
    ...
    get_filename_component(_photon_objcopy_name ${PHOTON_EMBED_OBJCOPY} NAME)
    string(TOLOWER "${_photon_objcopy_name}" _photon_objcopy_name_lower)
    ...
    elseif (WIN32)
        if (_photon_objcopy_name_lower MATCHES "llvm-objcopy")
            set(_photon_windows_x64_format coff-x86-64)
            set(_photon_windows_x86_format coff-i386)
        else()
            set(_photon_windows_x64_format pei-x86-64)
            set(_photon_windows_x86_format pe-i386)
        endif()

        if (CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|AMD64)$")
            set(PHOTON_EMBED_OBJ_FORMAT ${_photon_windows_x64_format} CACHE INTERNAL "")
            set(PHOTON_EMBED_OBJ_ARCH i386:x86-64 CACHE INTERNAL "")
        elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "^(i[3-6]86|x86)$")
            set(PHOTON_EMBED_OBJ_FORMAT ${_photon_windows_x86_format} CACHE INTERNAL "")
            set(PHOTON_EMBED_OBJ_ARCH i386 CACHE INTERNAL "")
        else()
