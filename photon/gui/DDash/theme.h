 ...
 */
bool LoadFonts(const char* fontPath = nullptr, const char* monoFontPath = nullptr,
...
inline ImU32 ColorToU32(const ImVec4& col) {
  return IM_COL32(static_cast<int>(col.x * 255.0f), static_cast<int>(col.y * 255.0f),
                  static_cast<int>(col.z * 255.0f), static_cast<int>(col.w * 255.0f));
}
