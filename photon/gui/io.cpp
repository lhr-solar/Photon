...
void IO::handleInput(SDL_Event* events){
...
inline void IO::addModifier(ImGuiIO& io, SDL_Keymod mod){
...
inline int IO::sdlMouseToImgui(Uint8 button){
    switch (button) {
...
ImGuiKey IO::sdlToImgui(SDL_Scancode scancode) {
    switch (scancode) {
